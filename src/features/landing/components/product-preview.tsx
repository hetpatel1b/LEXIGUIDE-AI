    ...
    <section className="w-full py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <Card className="max-w-5xl mx-auto border border-[var(--border)] bg-[var(--surface)] shadow-[var(--shadow-raised)] rounded-[var(--radius-xl)] overflow-hidden text-left">
          ...
          <div className="bg-slate-100 px-4 sm:px-6 py-3 border-b border-[var(--border)] flex flex-wrap items-center justify-between gap-3 text-xs">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-6 space-y-4">
                ...
                <div className="space-y-3">
                  {/* Concern Card */}
                  <div className="rounded-[var(--radius-md)] border border-amber-200 bg-[var(--warning-subtle)] p-3.5 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-semibold text-[var(--foreground)]">
                  ...
                  <div className="rounded-[var(--radius-md)] border border-slate-200 bg-[var(--surface-muted)] p-3.5 space-y-1.5">
                    <div className="flex items-center justify-between text-xs text-[var(--color-brand-blue)] font-semibold">
